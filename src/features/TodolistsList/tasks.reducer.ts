...
export type UpdateDomainTaskModelType = Partial<UpdateTaskModelType> // делает свойства не обязательные

export type TasksStateType = {
  [key: string]: Array<TaskType>;
};
/* export type TaskStateType = Record<string, TaskType[]> //// можно так*/
